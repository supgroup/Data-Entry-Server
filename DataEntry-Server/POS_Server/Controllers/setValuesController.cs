...
namespace Programs_Server.Controllers
{
 ...
 var strP = TokenManager.GetPrincipal(token);
            ...
            else
            {
                ...
                try
                {
                    List<setValuesModel> list = new List<setValuesModel>();
                    list = GetAll();
 ...
 var strP = TokenManager.GetPrincipal(token);
            ...
            else
            {
                ...
                {
                    List<setValuesModel> list = new List<setValuesModel>();
                    list= GetListBySetvalNote(setvalnote);
 ...
 var strP = TokenManager.GetPrincipal(token);
            ...
            else
            {
                ...
                try
                {
                    ...
                    setValuesModel item = new setValuesModel();
                    item = GetByID(Id);
 ...
 var strP = TokenManager.GetPrincipal(token);
            ...
            else
            {
                ...
                if (newObject != null)
                {
                    ...
                    try
                    {
                     decimal res=   SaveValueByNotes(newObject);
                        return TokenManager.GenerateToken(res.ToString());                 
 ...
 var strP = TokenManager.GetPrincipal(token);
        ...
        public decimal Save(setValues obj)
        {
            decimal message = 0;
        ...
        public List<setValuesModel> GetAll()
        {
        ...
        public   List<setValuesModel>  GetListBySetvalNote(string setvalnote)
        {
            List<setValuesModel> list = new List<setValuesModel>();
        ...
        // email
        public   List<setValuesModel>  GetvalBySetName(string name)
        {
        ...
        // email
        public  decimal  SaveValueByNotes(setValues obj)
        {
        ...
        public    setValuesModel  GetByID(int valId)
        {
            setValuesModel item = new setValuesModel();
            int Id = 0;
            try
